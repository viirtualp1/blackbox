      ...
      <Box sx={styles.initialContainer}>
        ...
        <Box sx={styles.contentColumn}>
          ...
          <Box sx={{ marginBottom: 3 }}>
            <h2
              style={{ fontSize: '1.5rem', fontWeight: 400, margin: '16px 0' }}
            >
            ...
            >
              Professional blackbox log analysis tool for EdgeTX firmware.
              Upload your CSV flight logs to visualize flight paths, analyze
              telemetry data, and gain insights to improve your RC flying
              performance.
            </p>
            ...
            <Box sx={{ fontSize: '0.95rem', marginBottom: 2 }}>
              ...
              <p style={{ margin: '8px 0' }}>
                📈 <strong>Performance Statistics</strong> - Calculate
                derivatives and performance metrics
              </p>
              <p style={{ margin: '8px 0' }}>
